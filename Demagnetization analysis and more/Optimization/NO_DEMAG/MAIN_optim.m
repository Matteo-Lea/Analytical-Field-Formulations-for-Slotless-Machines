...
el = 300; % population for magnets configuration (set it a multiple of 4)
...
% REP = Optimizer_2(params,params_mach,Var_max,Var_min,Int_min,Int_max,Const,adm,Constraints);
