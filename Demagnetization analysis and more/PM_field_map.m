...
% matteo.leandro.ml@gmail.com
% matteo@alvaindustries.com
% VERSION: 30Sep2020
...
% plotted. 
% For improved accuracy, the field solution in every region is multiplied
% by the Lanczos sigma cubed (variable sigma in the code)  to remove the 
% Gibbs phenomenon where it may occur (main problem in the magnets region).
...
m_PM = 1000; % number of harmonics or Fourier series components for the magnetization functions
x = 0:1:m_PM;
...
m_th = 1000;                                                                % points along one pole arc
m_th = m_th*sec;                                                            % points along the modeled sector
% mechanical angle
