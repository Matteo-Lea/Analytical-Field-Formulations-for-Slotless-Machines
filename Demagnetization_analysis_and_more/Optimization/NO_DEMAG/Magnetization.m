...
M_r_n_par_mid = Const(:,3)./mu_0.*x(:,1).*(M_1_0+M_2_0);
M_theta_n_par_mid = -Const(:,3)/mu_0.*x(:,1).*(M_1_0-M_2_0);
M_r_n_par_end_side = Const(:,4)/mu_0.*(alpha_p1.*(M_1_3-M_2_3)+(M_4_3-M_3_3));
M_theta_n_par_end_side = -Const(:,4)/mu_0.*(alpha_p1.*(M_2_3+M_1_3)-(M_3_3+M_4_3));
M_r_n_par_side = Const(:,4)/mu_0.*(x(:,1).*(M_1_2-M_2_2)+alpha_p1.*(M_4_2-M_3_2));
M_theta_n_par_side = -Const(:,4)/mu_0.*(x(:,1).*(M_2_2+M_1_2)-alpha_p1.*(M_3_2+M_4_2));
